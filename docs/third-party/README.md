...
<!--[[[fill sbom_sha256()]]]-->
The [SBOM in CycloneDX v1.4 JSON format](https://git.sr.ht/~sthagen/portinvartija/blob/default/etc/sbom/cdx.json) with SHA256 checksum ([9245b4e0 ...](https://git.sr.ht/~sthagen/portinvartija/blob/default/etc/sbom/cdx.json.sha256 "sha256:9245b4e04b56c1457ec04b2de71c537d6fe0ac79c41363f35d76a31a1e96b665")).
<!--[[[end]]] (checksum: 9ed5f1b68903f21182ef31feae8a4834)-->
## Licenses 
...
| [kdl-py](https://github.com/tabatkins/kdlpy/)                   | [1.1.4](https://pypi.org/project/kdl-py/1.1.4/)        | MIT License | Tab Atkins-Bittner <jackalmage@gmail.com> | A parser for the KDL data language.                                                                      |
...
<!--[[[end]]] (checksum: dcd37ad3d6f56bb276252e01b590bdef)-->
...
kdl-py==1.1.4
└── setuptools [required: >=68.0.0, installed: 68.2.2]
lxml==4.9.3
msgspec==0.18.4
PyYAML==6.0.1
toml==0.10.2
...
````
<!--[[[end]]] (checksum: 752e246d1e2c12db9c4fac507369007a)-->
